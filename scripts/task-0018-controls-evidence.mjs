...
function main() {
  ...
  const gate = protectedPromotionGate({ environment: 'pilot', approval: false, artifact: { immutable: true, signature_verified: true }, health: { passed: true }, reconciliation: { zero_drift: true } });
