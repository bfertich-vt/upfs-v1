...
test('GO requires all external prerequisites',()=>assert.equal(evaluateGoNoGo({externalApprovals:true,managedInfrastructure:true,credentials:true}).decision,'NO-GO_EXTERNAL_PREREQUISITES'));
