...
export const readSupportAccess = { method: "GET", path: "/admin/v1/support-access" } as const;
export const readCanonicalQuality = { method: "GET", path: "/admin/v1/canonical-quality" } as const;
export const readSearchProjections = { method: "GET", path: "/admin/v1/search-projections" } as const;
export const readRedisHealth = { method: "GET", path: "/admin/v1/redis" } as const;
export const readAiOperations = { method: "GET", path: "/admin/v1/ai-ops" } as const;
export const readSecurity = { method: "GET", path: "/admin/v1/security" } as const;
export const readPolicySimulator = { method: "GET", path: "/admin/v1/policy-simulator" } as const;
