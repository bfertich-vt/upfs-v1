...
export class IdentityFoundationService {
  ...
  create({ actor, kind, tenantId, idempotencyKey, ifMatch, attributes = {} }) {
    ...
    if (!['organization', 'tenant', 'environment', 'membership'].includes(kind)) return this.#error(400, 'unsupported_kind');
    ...
    if (kind !== 'organization' && !tenantId) return this.#error(400, 'tenant_required');
